            ...
            <table class="schedule-table">
                ...
                <?php if ($items): ?>
                    <?php foreach ($items as $x): ?>
                        ...
                        <tr><td><?= e((string) ($x['no_registrasi'] ?? '-')) ?></td><td><?= e((string) ($x['no_surat'] ?? '-')) ?></td><td><?= e((string) ($x['perihal'] ?? '-')) ?></td><td><?= e((string) ($x['nama_unit'] ?? '-')) ?></td><td><span class="schedule-date <?= e($indicator['class']) ?>"><?= e($indicator['label']) ?></span></td><td><span class="schedule-badge <?= e($badge['class']) ?>"><?= e($badge['label']) ?></span></td><td><a class="archive-detail-link" href="arsip-detail.php?id=<?= e((string) ($x['arsip_id'] ?? 0)) ?>"><i class="material-symbols-outlined">visibility</i>Lihat Detail</a></td></tr>
                    <?php endforeach; ?>
                <?php else: ?>
